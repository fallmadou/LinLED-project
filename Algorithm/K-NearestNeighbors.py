...
# param_grid = {
#     'n_neighbors': [10],
#     'weights': ['uniform'],   # weight all neighbors equally
#     'p': [1],                 # distance metric: Manhattan (p=1) or Euclidean (p=2)
# }
...
# Ensure that X_test is stored in a contiguous block of memory.  
# This can sometimes improve performance for libraries that expect 
# contiguous arrays (like NumPy or scikit-learn).
