...
# # Comment / Uncomment to perform grid search
# hgb =  HistGradientBoostingClassifier()
# start_time = time.time()
# grid_search = GridSearchCV(hgb, param_grid, cv=5, n_jobs=-1, scoring='accuracy')
# grid_search.fit(X_train, y_train)
# end_time = time.time()
# best_model = grid_search.best_estimator_
# print("Best params:", grid_search.best_params_)

# Comment / Uncomment for quick training without grid search
