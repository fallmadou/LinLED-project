# -*- coding: utf-8 -*-
"""
Created on Wed Jul 16 16:07:48 2025
...
# ==============================
# HistGradientBoosting training (uncomment to tune)
# ==============================


# Example hyperparameter grid for HistGradientBoostingClassifier:
# - learning_rate: step size for updates (smaller values can improve generalization)
# - max_iter: number of boosting iterations (trees)
# - max_depth: maximum depth of each tree (None = unlimited)
# - l2_regularization: L2 regularization strength to prevent overfitting


# Uncomment and adjust these values to perform hyperparameter tuning with GridSearchCV
# param_grid = {
#     'learning_rate': [0.1],
#     'max_iter': [50],
#     'max_depth': [None],
...
# Initialize the HistGradientBoosting classifier with default settings
